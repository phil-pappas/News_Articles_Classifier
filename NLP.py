...
class NLP:
    ...
    def lemmatize(self, articles_split_by_word):
    ...
    # FIX THIS FUNCTION
    def stemming(self, articles_split_by_word):
        articles_split_by_word = articles_split_by_word.apply(
